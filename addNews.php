<?php
  ...
  if (isset($_POST['addNews'])) {
    ...
    $conn->query("INSERT INTO `news`(`heading`, `description`, `time`) VALUES ('$nHeading','$nDescription',Now())");

  }

  $row1 = $conn->query("SELECT * FROM `news` WHERE 1");
      ...
      <div class="page-content d-flex align-items-stretch">
        ...
        <nav class="side-navbar">
          ...
          <ul class="list-unstyled">
            ...
            <li class="active"> <a href="#"> <i class="fa fa-newspaper-o"></i>Add News</a></li>
        ...
        <div class="content-inner">
          ...
          <header class="page-header">
            <div class="container-fluid">
              <h2 class="no-margin-bottom">Add News</h2>
            </div>
          </header>
          <!-- Breadcrumb-->
          ...
          <section class="forms">
                <div class="container-fluid">
                  ...
                  <div class="col-lg-12">
                    <div class="card my-4">
                        <h3 align="center" class="card-header">Add News</h3>
                        <div class="card-body">
                          <div class="row my-2">
                                      ...
                                      <div class="tab-pane active" id="news">
                                          <form role="form" method="post" action="">
                                              <div class="form-group row">
                                                  <label class="col-lg-3 col-form-label form-control-label">News Heading</label>
                                                  <div class="col-lg-9">
                                                      <input class="form-control" type="text" name="heading" autocomplete="off">
                                                  </div>
                                              </div>
                                              <div class="form-group row">
                                                  <label class="col-lg-3 col-form-label form-control-label">News Description</label>
                                                  <div class="col-lg-9">
                                                      <textarea rows="3" class="form-control" placeholder="Write Description" name="description" autocomplete="off"></textarea>
                                                  </div>
                                              </div>
                                              <div class="form-group row">
                                                  ...
                                                  <div class="col-lg-9">
                                                      ...
                                                      <button type="submit" class="btn btn-primary" name="addNews">Add News</button>
                                                  </div>
                                              </div>
                                          </form>
                                      </div>
                    ...
                    <div class="card-body">
                      <table class="table table-striped table-sm">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td> <?php echo $result1['heading']; ?> </td>
                            <td> <?php echo $result1['description']; ?> </td>
                            <td> <?php echo $result1['time']; ?> </td>
                            <td><a onclick="return confirm('Are you sure want to Delete?')" href="deleteNews.php?id=<?php echo $result1['id']; ?>" class="btn btn-danger"><i class="fa fa-trash-o" aria-hidden="true"></i></a></td>
                            <td><a onclick="return confirm('Are you sure want to Update?')" href="updateNews.php?id=<?php echo $result1['id']; ?>" class="btn btn-warning"><i class="fa fa-edit" aria-hidden="true"></i></a></td>
                          </tr>
                        <?php } ?>
                        </tbody>
                      </table>
