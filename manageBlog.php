<?php
  ...
  $row1 = $conn->query("SELECT * FROM `blog` WHERE (author_type = 'faculty') order by id desc");
  $row2 = $conn->query("SELECT * FROM `blog` WHERE (author_type = 'alumni') order by id desc");
      ...
      <div class="page-content d-flex align-items-stretch">
        ...
        <nav class="side-navbar">
          ...
          <ul class="list-unstyled">
            ...
            <li class="active"> <a href="#"> <i class="fa fa-book"></i>Manage Blogs</a></li>
        ...
        <div class="content-inner">
          ...
          <header class="page-header">
            <div class="container-fluid">
              <h2 class="no-margin-bottom">Manage Blog</h2>
            </div>
          </header>
          <!-- Breadcrumb-->
                      ...
                      <table class="table table-striped table-sm">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td> <?php echo $result1['author']; ?> </td>
                            <td> <?php echo $result1['time']; ?> </td>
                            <td><a onclick="return confirm('Are you sure want to delete?')" href="deleteBlog.php?id= <?php echo $result1['id']; ?>" class="btn btn-danger"><i class="fa fa-trash-o" aria-hidden="true"></i></a></td>
                          </tr>
                        <?php } ?>
                        </tbody>
                      </table>
                      ...
                      <table class="table table-striped table-sm">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><a onclick="return confirm('Are you sure want to delete?')" href="deleteBlog.php?id= <?php echo $result2['id']; ?>" class="btn btn-danger"><i class="fa fa-trash-o" aria-hidden="true"></i></a></td>
                          </tr>
                        <?php } ?>
                        </tbody>
                      </table>
