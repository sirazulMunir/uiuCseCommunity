          ...
          <div class="container-fluid">
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              ...
              <div class="navbar-header">
                <img src="img/uiu.png" height="35" width="45" alt=""><a href="index.html" class="navbar-brand">
      ...
      <div class="page-content d-flex align-items-stretch">
        ...
        <nav class="side-navbar">
          ...
          <ul class="list-unstyled">
            ...
            <li class="active"> <a href="charts.html"> <i class="fa fa-bar-chart"></i>Chart View</a></li>
            ...
            <div class="container-fluid">
              <div class="row">
                ...
                <div class="col-lg-12">
                  <div class="bar-chart-example card">
                    <div class="card-header d-flex align-items-center">
                      <h3 class="h4">Alumni Student Join Bar Chart</h3>
                    </div>
                    <div class="card-body">
