<?php
  ...
  $row1 = $conn->query("SELECT COUNT(id) as F FROM `faculty` WHERE 1");
  $row2= $conn->query("SELECT COUNT(id) as A FROM `alumni` WHERE 1");
  $row3 = $conn->query("SELECT COUNT(id) as S FROM `student` WHERE 1");
  $row4 = $conn->query("SELECT COUNT(id) as N FROM `news` WHERE 1");
  $row5 = $conn->query("SELECT COUNT(id) as E FROM `events` WHERE 1");
  $row6 = $conn->query("SELECT COUNT(id) as B FROM `blog` WHERE 1");
  $row7 = $conn->query("SELECT COUNT(id) as J FROM `job` WHERE 1");
      ...
      <div class="page-content d-flex align-items-stretch">
        ...
        <nav class="side-navbar">
          ...
          <ul class="list-unstyled">
            ...
            <li> <a href="manageJob.php"> <i class="fa fa-briefcase"></i>Manage Jobs</a></li>
          </ul>
        </nav>
              ...
              <div class="row bg-white has-shadow">
                ...
                <div class="col-xl-3 col-sm-6">
                  <div class="item d-flex align-items-center">
                    ...
                    <div class="title"><span>Total<br>Faculty</span>
                      <div class="progress">
                        <div role="progressbar" style="width: 55%; height: 4px;" aria-valuenow="{#val.value}" aria-valuemin="0" aria-valuemax="100" class="progress-bar bg-violet"></div>
                      </div>
                    </div>
                    <div class="number"><strong><?php echo $result1['F']; ?></strong></div>
                  </div>
                </div>
                <!-- Item -->
                <div class="col-xl-3 col-sm-6">
                  <div class="item d-flex align-items-center">
                    <div class="icon bg-red"><i class="fa fa-graduation-cap"></i></div>
                    <div class="title"><span>Total<br>Alumni</span>
                      <div class="progress">
                        <div role="progressbar" style="width: 60%; height: 4px;" aria-valuenow="{#val.value}" aria-valuemin="0" aria-valuemax="100" class="progress-bar bg-red"></div>
                      </div>
                    </div>
                    <div class="number"><strong><?php echo $result2['A']; ?></strong></div>
                  </div>
                </div>
                <!-- Item -->
                <div class="col-xl-3 col-sm-6">
                  <div class="item d-flex align-items-center">
                    ...
                    <div class="number"><strong><?php echo $result3['S']; ?></strong></div>
                  </div>
                </div>
                ...
                <div class="col-xl-3 col-sm-6">
                  <div class="item d-flex align-items-center">
                    ...
                    <div class="title"><span>Total<br>Blogs</span>
                      <div class="progress">
                        <div role="progressbar" style="width: 40%; height: 4px;" aria-valuenow="{#val.value}" aria-valuemin="0" aria-valuemax="100" class="progress-bar bg-green"></div>
                      </div>
                    </div>
                    <div class="number"><strong><?php echo $result6['B']; ?></strong></div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="container-fluid">
              <div class="row bg-white has-shadow">
                ...
                <div class="col-xl-4 col-sm-6">
                  <div class="item d-flex align-items-center">
                    <div class="icon bg-violet"><i class="fa fa-briefcase"></i></div>
                    <div class="title"><span>Total<br>Jobs</span>
                      <div class="progress">
                        <div role="progressbar" style="width: 55%; height: 4px;" aria-valuenow="{#val.value}" aria-valuemin="0" aria-valuemax="100" class="progress-bar bg-violet"></div>
                      </div>
                    </div>
                    <div class="number"><strong><?php echo $result7['J']; ?></strong></div>
                  </div>
                </div>
                <!-- Item -->
                <div class="col-xl-4 col-sm-6">
                  <div class="item d-flex align-items-center">
                    <div class="icon bg-red"><i class="fa fa-newspaper-o"></i></div>
                    <div class="title"><span>Total<br>News</span>
                      <div class="progress">
                        <div role="progressbar" style="width: 60%; height: 4px;" aria-valuenow="{#val.value}" aria-valuemin="0" aria-valuemax="100" class="progress-bar bg-red"></div>
                      </div>
                    </div>
                    <div class="number"><strong><?php echo $result4['N']; ?></strong></div>
                  </div>
                </div>
                <!-- Item -->
                <div class="col-xl-4 col-sm-6">
                  <div class="item d-flex align-items-center">
                    ...
                    <div class="number"><strong><?php echo $result5['E']; ?></strong></div>
                  </div>
                </div>
              </div>
            </div>
