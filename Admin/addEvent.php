<?php
    ...
    if (isset($_POST['addEvent'])) {
      $eHeading= $_POST['heading'];
      $eDescription= $_POST['description'];

      $conn->query("INSERT INTO `events`(`heading`, `description`, `time`) VALUES ('$eHeading','$eDescription', Now())");
      header('location: addEvent.php');
    }

    $row1 = $conn->query("SELECT * FROM `events` WHERE 1");
    $conn->close();
 ?>
      ...
      <div class="page-content d-flex align-items-stretch">
        ...
        <nav class="side-navbar">
          ...
          <ul class="list-unstyled">
            ...
            <li class="active"> <a href="#"> <i class="fa fa-calendar"></i>Add Event</a></li>
        ...
        <div class="content-inner">
          ...
          <header class="page-header">
            <div class="container-fluid">
              <h2 class="no-margin-bottom">Add Event</h2>
            </div>
          </header>
          <!-- Breadcrumb-->
          ...
          <section class="forms">
                <div class="container-fluid">
                    <div class="row">
                      <div class="col-lg-12">
                        <div class="card my-4">
                            <h3 align="center" class="card-header">Insert Event</h3>
                            <div class="card-body">
                              <div class="row my-2">
                                          ...
                                          <div class="tab-pane active" id="news">
                                              <form role="form" method="post" action="">
                                                  <div class="form-group row">
                                                      <label class="col-lg-3 col-form-label form-control-label">Event Heading</label>
                                                      <div class="col-lg-9">
                                                          <input class="form-control" type="text" autocomplete="off" name="heading">
                                                      </div>
                                                  </div>
                                                  <div class="form-group row">
                                                      <label class="col-lg-3 col-form-label form-control-label">Event Description</label>
                                                      <div class="col-lg-9">
                                                          <textarea rows="3" class="form-control" placeholder="Write Description" name="description"></textarea>
                                                      </div>
                                                  </div>
                                                  <div class="form-group row">
                            ...
                            <table class="table table-striped table-sm">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td><a onclick="return confirm('Are you sure want to Delete?')" href="deleteEvent.php?id=<?php echo $result1['id']; ?>" class="btn btn-danger"><i class="fa fa-trash-o" aria-hidden="true"></i></a></td>
                                  <td><a onclick="return confirm('Are you sure want to Update?')" href="updateEvent.php?id=<?php echo $result1['id']; ?>" class="btn btn-warning"><i class="fa fa-edit" aria-hidden="true"></i></a></td>
                                </tr>
                              <?php } ?>
                              </tbody>
                            </table>
