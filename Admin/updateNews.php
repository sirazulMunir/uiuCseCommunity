<?php
  ...
  $row1 = $conn->query("SELECT * FROM `news` WHERE id = $id ");
  ...
  if (isset($_POST['updateNews'])) {
    ...
    $conn->query("UPDATE `news` SET `heading`='$nHeading',`description`='$nDescription' WHERE (id = '$id')");
        ...
        <div class="content-inner">
          ...
          <section class="forms">
                <div class="container-fluid">
                  ...
                  <div class="col-lg-12">
                    <div class="card my-4">
                        <h3 align="center" class="card-header">Update News</h3>
                        <div class="card-body">
                          <div class="row my-2">
                                      ...
                                      <div class="tab-pane active" id="news">
                                          <form role="form" method="post" action="">
                                              ...
                                              <div class="form-group row">
                                                  ...
                                                  <div class="col-lg-9">
                                                      <button type="submit" class="btn btn-primary" name="updateNews">Update News</button>
                                                  </div>
                                              </div>
                                          </form>
                                      </div>
