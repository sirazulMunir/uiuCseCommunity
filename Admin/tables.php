<?php
    ...
    $row1 = $conn->query("SELECT * FROM `faculty` WHERE 1");
    $row2 = $conn->query("SELECT * FROM `alumni` WHERE 1");
    $row3 = $conn->query("SELECT * FROM `student` WHERE 1");
      ...
      <div class="page-content d-flex align-items-stretch">
        ...
        <nav class="side-navbar">
          ...
          <ul class="list-unstyled">
            ...
            <li class="active"><a href="tables.php"> <i class="icon-grid"></i>Table View</a></li>
        ...
        <div class="content-inner">
          ...
          <header class="page-header">
            <div class="container-fluid">
              <h2 class="no-margin-bottom">Member Table View</h2>
            </div>
          </header>
          <!-- Breadcrumb-->
                ...
                <div class="col-lg-12">
                  <div class="card">
                    ...
                    <div class="card-header d-flex align-items-center">
                      <h3 class="h4">Faculty Members</h3>
                    </div>
                    <div class="card-body">
                      <table class="table table-striped table-sm">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td> <?php echo $result1['designation']; ?> </td>
                            <td> <?php echo $result1['email']; ?> </td>
                            <td><a onclick="return confirm('Are you sure want to delete?')" href="deleteFaculty.php?id=<?php echo $result1['id']; ?>" class="btn btn-danger"><i class="fa fa-trash-o" aria-hidden="true"></i></a></td>
                          </tr>
                        <?php } ?>
                        </tbody>
                      </table>
                      ...
                      <table class="table table-striped table-sm">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td> <?php echo $result2['company']; ?> </td>
                            <td><a onclick="return confirm('Are you sure want to delete?')" href="deleteAlumni.php?id= <?php echo $result2['id']; ?>" class="btn btn-danger"><i class="fa fa-trash-o" aria-hidden="true"></i></a></td>
                          </tr>
                        <?php } ?>
                        </tbody>
                      </table>
                      ...
                      <table class="table table-striped table-sm">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td> <?php echo $result3['sID']; ?> </td>
                            <td> <?php echo $result3['email']; ?> </td>
                            <td><a onclick="return confirm('Are you sure want to delete?')" href="deleteStudent.php?id=<?php echo $result3['id']; ?>" class="btn btn-danger"><i class="fa fa-trash-o" aria-hidden="true"></i></a></td>
                          </tr>
                        <?php } ?>
                        </tbody>
                      </table>
