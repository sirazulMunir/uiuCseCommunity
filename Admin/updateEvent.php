<?php
  ...
  $row1 = $conn->query("SELECT * FROM `events` WHERE id = $id ");
  ...
  if (isset($_POST['updateEvent'])) {
    ...
    $conn->query("UPDATE `events` SET `heading`='$nHeading',`description`='$nDescription' WHERE (id = '$id')");
      ...
      <div class="page-content d-flex align-items-stretch">
        ...
        <nav class="side-navbar">
          ...
          <ul class="list-unstyled">
            ...
            <li class="active"> <a href="addNews.php"> <i class="fa fa-newspaper-o"></i>Add News</a></li>
        ...
        <div class="content-inner">
          ...
          <header class="page-header">
            <div class="container-fluid">
              <h2 class="no-margin-bottom">Update Event</h2>
            </div>
          </header>
          <!-- Breadcrumb-->
          ...
          <section class="forms">
                <div class="container-fluid">
                  ...
                  <div class="col-lg-12">
                    <div class="card my-4">
                        <h3 align="center" class="card-header">Update Event</h3>
                        <div class="card-body">
                          <div class="row my-2">
                                      ...
                                      <div class="tab-pane active" id="news">
                                          <form role="form" method="post" action="">
                                              <div class="form-group row">
                                                  ...
                                                  <div class="col-lg-9">
                                                      <input class="form-control" type="text" name="heading" value=" <?php echo $result1['heading']; ?> ">
                                                  </div>
                                              </div>
                                              <div class="form-group row">
                                                  <label class="col-lg-3 col-form-label form-control-label">Event Description</label>
                                                  <div class="col-lg-9">
                                                      <input class="form-control" type="text" name="description" value=" <?php echo $result1['description']; ?> ">
                                                  </div>
                                              </div>
                                              <div class="form-group row">
                                                  <label class="col-lg-3 col-form-label form-control-label"></label>
                                                  <div class="col-lg-9">
                                                      <button type="submit" class="btn btn-primary" name="updateEvent">Update Event</button>
                                                  </div>
                                              </div>
                                          </form>
                                      </div>
