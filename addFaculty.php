<?php
  ...
  if (isset($_POST['facultyInsert'])) {
    ...
    $fDesi= $_POST['facultyDesignation'];
    $fEmail= $_POST['facultyEmail'];
    $fPass = $_POST['facultyPassword'];

    $target= "../Photos/".basename($_FILES['facultyPhoto']['name']);
    $image = $_FILES['facultyPhoto']['name'];
    move_uploaded_file($_FILES['facultyPhoto']['tmp_name'],$target);

    $conn->query("INSERT INTO `faculty`(`name`, `designation`, `email`, `password`, `facultyPhoto`)
    VALUES ('$fName','$fDesi','$fEmail','$fPass','$image')");
      ...
      <div class="page-content d-flex align-items-stretch">
        ...
        <nav class="side-navbar">
          ...
          <ul class="list-unstyled">
            ...
            <li class="active"> <a href="#"> <i class="fa fa-user-o"></i>Add Faculty </a></li>
        ...
        <div class="content-inner">
          ...
          <header class="page-header">
            <div class="container-fluid">
              <h2 class="no-margin-bottom">Add Faculty Member</h2>
            </div>
          </header>
          <!-- Breadcrumb-->
          ...
          <section class="forms">
                <div class="container-fluid">
                  <div class="card my-4">
                      <h3 align="center" class="card-header">Insert Faculty Information</h3>
                      <div class="card-body">
                        <div class="row my-2">
                            <div class="col-lg-8 order-lg-2">
                                <div class="tab-content py-4">
                                    <div class="tab-pane active" id="faculty">
                                        <form role="form" id="facultyEntry" method="post" action="" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-lg-3 col-form-label form-control-label">Degignation</label>
                                                <div class="col-lg-9">
                                                    <input class="form-control" type="text" name="facultyDesignation">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-lg-3 col-form-label form-control-label">Email</label>
                                                <div class="col-lg-9">
                                                    <input class="form-control" type="email" name="facultyEmail">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-lg-3 col-form-label form-control-label">Password</label>
                                                <div class="col-lg-9">
                                                    <input class="form-control" type="password" name="facultyPassword">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-lg-3 col-form-label form-control-label">Confirm password</label>
                                                <div class="col-lg-9">
                                                    <input class="form-control" type="password" name="facultyConPassword">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9">
                                                    ...
                                                    <button type="submit" class="btn btn-primary" name="facultyInsert">Add Faculty</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
