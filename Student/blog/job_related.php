          ...
          <ul class="navbar-nav ml-auto">
           ...
           <li class="nav-item" style="border-right: 1px solid;">
            ...
            <li class="nav-item active" style="border-right: 1px solid;">
              <a class="nav-link" href="blog.html"><i class="fa fa-book" aria-hidden="true"></i> Blog<span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item" style="border-right: 1px solid;">
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          ...
          <h1 align="center" class="my-4">Job Blogs
            <!--<small>Secondary Text</small>-->
          </h1>

          <!-- Blog Post -->
          <div class="card mb-4">
            <img class="card-img-top" src="img/job.jpg" height="300" width="760" alt="Career image">
            <div class="card-body">
              <h2 class="card-title">Build Career</h2>
              <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reiciendis aliquid atque, nulla? Quos cum ex quis soluta, a laboriosam. Dicta expedita corporis animi vero voluptate voluptatibus possimus, veniam magni quis!</p>
              <a href="details.html" class="btn btn-primary">Read More &rarr;</a>
            </div>
            <div class="card-footer text-muted">
              Posted on December 10, 2017 by <a href="facultyDetails.php">Professor Dr. Chowdhury Mofizur Rahman</a>
            </div>
          </div>

          <!-- Blog Post -->
          <div class="card mb-4">
            <img class="card-img-top" src="img/job.jpg" height="300" width="760" alt="Card image cap">
            <div class="card-body">
              <h2 class="card-title">Find Dream Job</h2>
              <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reiciendis aliquid atque, nulla? Quos cum ex quis soluta, a laboriosam. Dicta expedita corporis animi vero voluptate voluptatibus possimus, veniam magni quis!</p>
