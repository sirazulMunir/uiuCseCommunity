   ...
   <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item" style="border-right: 1px solid;">
              <a class="nav-link" href="job/job_list.php"><i class="fa fa-briefcase" aria-hidden="true"></i> Jobs</a>
            </li>
            <li class="nav-item" style="border-right: 1px solid;">
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-8">
            <div class="card my-4">
                <h3 align="center" class="card-header">Faculty</h3>
                    <div class="card-body">
                       <table class="table table-striped" id="student_table">
                            ...
                            <tbody>
                              ...
                              <tr>
                                <td> <img class="img-thumbnail avatar avatar-original" style="-webkit-user-select:none; display:block; margin:auto;"  width="50" height="50" <?php echo "<img src='../Photos/".$result2['facultyPhoto']."'> "; ?> </td>
                                <td> <a href="facultyDetails.php?id=<?php echo $result2['id']; ?>"> <?php echo $result2['name']; ?> </a></td>
          ...
          <div class="card my-4">
            ...
            <div class="card-body">
              <div class="input-group">
               ...
               <input type="text" name="search_text" id="search_text" placeholder="Type faculty name" class="form-control"/>
              </div>
            </div>
