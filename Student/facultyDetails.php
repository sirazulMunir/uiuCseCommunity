<?php
    ...
    if (isset($_POST['submitSMS'])) {
      $sms = $_POST['description'];

      $conn->query("INSERT INTO `messages`(`sender`,`receiver`, `sms`) VALUES ('$sender','$nm' ,'$sms')");
    }
                        ...
                        <div class="tab-pane" id="messages">
                            <form role="form" method="post" action="" enctype="multipart/form-data">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <textarea rows="3" class="form-control" name="description" placeholder="Type Your Message"></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label form-control-label"></label>
                                    <div class="col-lg-9">
                                        <button type="submit" class="btn btn-success" name="submitSMS"><i class="fa fa-paper-plane" aria-hidden="true"></i> Send</button>
                                    </div>
                                </div>
                            </form>
                        </div>
