<?php
    ...
    $row1 = $conn->query("SELECT * FROM `alumni` WHERE (id='$id' )");
...
<html lang="en">
  ...
  <body>
   ...
   <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    ...
    <div class="container">
      <div class="card my-4">
          <h3 align="center" class="card-header">Alumni Details</h3>
          <div class="card-body">
            <div class="row my-2">
                ...
                <div class="col-lg-4 order-lg-1 text-center">
                  <img class="img-thumbnail avatar avatar-original" style="-webkit-user-select:none; display:block; margin:auto;"  width="300" height="250" <?php echo "<img src='../Photos/".$result2['alumniphoto']."'> "; ?><hr>
    ...
    <footer class="py-3 bg-dark">
      <div class="container">
        <p class="m-0 text-center text-white">Copyright &copy;Munir 2017</p>
      </div>
      <!-- /.container -->
    </footer>
