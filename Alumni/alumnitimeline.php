<?php
  ...
  $user = $_SESSION['email'];
  $sq = $conn->query("SELECT * FROM `alumni` WHERE (email = '$user') ");
  $result1 = mysqli_fetch_array($sq);
  ...
  if(isset($_POST['Edit'])) {
    ...
    $aProjects = $_POST['Projects'];
    $aHobby = $_POST['Hobby'];
    $aFacebookID = $_POST['fID'];
    $aTwitterID = $_POST['tID'];
    $aLinkedInID = $_POST['InID'];
    $aAddress = $_POST['Address'];
    $aPassword = $_POST['Password'];

    $s = $conn->query(" UPDATE `alumni` SET `name`='$aName',`email`='$aEmail',`designation`='$aDesignation',
           `company`='$aCompany',`experience`='$aExperience',`projects`='$aProjects', `hobby`='$aHobby',`fID`='$aFacebookID',
           `tID`='$aTwitterID',`inID`='$aLinkedInID',`address`='$aAddress', `password`='$aPassword'
            WHERE (email = '$user') ");
  ...
  if (isset($_POST['post'])) {
    ...
    $bDescription = $_POST['blogDescription'];
    $tit=str_replace("'","''",$bTitle);
    $dis=str_replace("'","''",$bDescription);

    $target = "../Photos/".basename($_FILES['blogPhoto']['name']);
    $image= $_FILES['blogPhoto']['name'];
    move_uploaded_file($_FILES['blogPhoto']['tmp_name'],$target);
          ...
          <div class="card-body">
            <div class="row my-2">
                        ...
                        <div class="tab-pane" id="blogpost">
                            <form role="form" action="" method="post" enctype="multipart/form-data">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input class="form-control" type="text" placeholder="Title" name="blogTitle">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <select id="blogType" class="form-control" size="0" name="blogType">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <textarea rows="3" class="form-control" placeholder="Description" name="blogDescription"></textarea>
                                    </div>
                                </div>
                                  <div class="col-lg-4 order-lg-1 text-left" style="align-content: right; float: right;">
                                        <h6 class="">Upload Blog Thumbnail</h6>
                                        <label class="custom-file">
                                            <input type="file" class="form-control" name="blogPhoto" autocomplete="off"/>
                                        </label>
                ...
                <div class="col-lg-4 order-lg-1 text-center">
                    <img class="img-thumbnail avatar avatar-original" style="-webkit-user-select:none; display:block; margin:auto;"  width="300" height="450" <?php echo "<img src='../Photos/".$result1['alumniphoto']."'> "; ?>
                    <h6 class="mt-2">
                </div>
