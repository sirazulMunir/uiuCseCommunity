<?php
    ...
    $row1 = $conn->query("SELECT * FROM `student` WHERE (id='$id' )");
...
<html lang="en">
  ...
  <body>
   ...
   <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    ...
    <div class="container">
      <div class="card my-4">
          <h3 align="center" class="card-header">Student Details</h3>
          <div class="card-body">
            <div class="row my-2">
                    ...
                    <div class="tab-content py-4">
                        <div class="tab-pane active" id="profile">
                          ...
                          <div class="row">
                            <div class="col-md-6">
                                <h5>Student ID</h5>
                                <p> <?php echo $result2['sID']; ?> </p>
                                <h5>Designation</h5>
                                <p> <?php echo $result2['designation']; ?></p>
                            </div>
                              <div class="col-md-6">
                                  <h5>Blood Group</h5>
                                  <p> <?php echo $result2['blood']; ?> </p>
                                  <h5>Hobbies</h5>
                ...
                <div class="col-lg-4 order-lg-1 text-center">
                  <img class="img-thumbnail avatar avatar-original" style="-webkit-user-select:none; display:block; margin:auto;"  width="300" height="250" <?php echo "<img src='../Photos/".$result2['sPhoto']."'> "; ?><hr>
